...
export default function BottomNav() {
  ...
  const rightItems = [
    { href: '/wallets', icon: Wallet, label: 'Poches', coachId: 'nav-wallets' },
    { href: '/categories', icon: Tag, label: 'Catég.', coachId: 'nav-categories' },
  ...
  const fabClass =
    'absolute left-1/2 -translate-x-1/2 -top-5 w-14 h-14 rounded-2xl bg-primary-950 shadow-soft flex items-center justify-center text-white hover:bg-ink transition touch-manipulation border-[3px] border-surface disabled:opacity-60'
    ...
    <>
        ...
        <div className="fixed inset-0 z-[45] pointer-events-none">
          ...
          <div className="absolute bottom-[154px] left-0 right-0 px-4 pointer-events-none">
            <div className="max-w-md mx-auto pointer-events-auto">
              <div className="rounded-2xl bg-white shadow-card border border-black/[0.04] px-4 pt-4 pb-5">
                <p className="text-center text-sm font-semibold text-ink mb-4">
                ...
                <div className="grid grid-cols-3 gap-2">
                  <Link
                    ...
                    className="flex flex-col items-center gap-2 py-3 rounded-xl bg-surface-muted text-primary-800 touch-manipulation active:scale-[0.98] transition"
                  >
                    <span className="w-11 h-11 rounded-xl bg-white border border-black/[0.04] flex items-center justify-center">
                  ...
                  <button
                    ...
                    disabled={scanning}
                    className="flex flex-col items-center gap-2 py-3 rounded-xl bg-surface-muted text-primary-800 touch-manipulation active:scale-[0.98] transition disabled:opacity-60"
                  >
                    <span className="w-11 h-11 rounded-xl bg-white border border-black/[0.04] flex items-center justify-center">
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 pointer-events-none">
        <div className="max-w-md mx-auto px-4 pb-4 pointer-events-auto">
          <div className="relative nav-surface rounded-2xl shadow-nav px-1.5 pt-2.5 pb-1.5">
